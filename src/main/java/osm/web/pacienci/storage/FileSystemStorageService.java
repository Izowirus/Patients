package osm.web.pacienci.storage;
...
public class FileSystemStorageService implements StorageService {
    ...
    public FileSystemStorageService(StorageProperties properties) {
    	this.rootString = properties.getLocation();
    ...
    public void delete(String name){
    	try {
			Files.delete(Paths.get(rootString, name));
		} catch (IOException e) {
			System.err.println("Problem with deleting file: " + name);
		}
    }
